  ...
  function initI18n() {
    const translations = {
      ...
      en: {
        ...
        "demos.d5.title": "Yoga Studio",
        "demos.d5.text": "Calming, minimalist design focusing on the trainer and a clear invitation for a trial class.",
        "demos.d5.result": "More class inquiries through harmonious user guidance.",
        "demos.d6.title": "Car Dealership",
        "demos.d6.text": "Trust-building design focused on expertise, customer reviews, and easy vehicle inquiries.",
        "demos.d6.result": "More inquiries and higher trust from buyers.",
        "demos.d7.title": "REAL ESTATE BROKER",
        "demos.d7.text": "Exclusive presentation of high-quality properties with smart filters and elegant dark-mode design.",
        "demos.d7.result": "Higher trust and more qualified leads.",
        "demos.d8.title": "ONLINE SHOP",
        "demos.d8.text": "Premium E-Commerce experience. Aesthetic product cards, smooth checkout, and lightning-fast load times.",
        "demos.d8.result": "Higher conversion rate among shop visitors.",
        "demos.tag.starter": "Starter Package",
        "demos.tag.business": "Business Package",
        "demos.tag.premium": "Premium Package",
        ...
        "marquee.title": "Trusted by local market leaders",
        "testi.kicker": "Testimonials",
        "testi.title": "What our clients say.",
        "testi.subtitle": "Websites that deliver real results in practice.",
        "testi.q1.text": "Since we got the new website from Lumi Digital, the number of our new inquiries has tripled. The process was extremely professional and fast!",
        "testi.q1.name": "Johannes Müller",
        "testi.q1.role": "Owner, Craft Business",
        "testi.q2.text": "Finally a website that looks perfect on mobile and loads super fast. Our table reservations have gone up massively.",
        "testi.q2.name": "Sarah Weber",
        "testi.q2.role": "Manager, Restaurant",
      ...
      de: {
        ...
        "demos.d5.title": "Yoga Studio",
        "demos.d5.text": "Beruhigendes, minimalistisches Design mit Fokus auf den Trainer und einer klaren Einladung zur Probestunde.",
        "demos.d5.result": "Mehr Kursanfragen durch harmonische Nutzerführung.",
        "demos.d6.title": "Autohändler",
        "demos.d6.text": "Vertrauenserweckendes Design mit klarem Fokus auf Expertise, Kundenbewertungen und einfache Fahrzeug-Anfragen.",
        "demos.d6.result": "Mehr Anfragen und höheres Vertrauen bei Käufern.",
        "demos.d7.title": "IMMOBILIENMAKLER",
        "demos.d7.text": "Exklusive Präsentation hochwertiger Objekte mit smarten Filtern und elegantem Dark-Mode Design.",
        "demos.d7.result": "Höheres Vertrauen und mehr qualifizierte Leads.",
        "demos.d8.title": "ONLINE SHOP",
        "demos.d8.text": "Premium E-Commerce Erlebnis. Ästhetische Produktkarten, reibungsloser Checkout und blitzschnelle Ladezeiten.",
        "demos.d8.result": "Höhere Conversion-Rate bei Shop-Besuchern.",
        "demos.tag.starter": "Starter Paket",
        "demos.tag.business": "Business Paket",
        "demos.tag.premium": "Premium Paket",
        ...
        "marquee.title": "Vertraut von lokalen Marktführern",
        "testi.kicker": "Kundenstimmen",
        "testi.title": "Das sagen unsere Kunden.",
        "testi.subtitle": "Webseiten, die echte Ergebnisse in der Praxis liefern.",
        "testi.q1.text": "Seitdem wir die neue Webseite von Lumi Digital haben, hat sich die Anzahl unserer Neuanfragen verdreifacht. Der Prozess war extrem professionell und schnell!",
        "testi.q1.name": "Johannes Müller",
        "testi.q1.role": "Inhaber, Handwerksbetrieb",
        "testi.q2.text": "Endlich eine Webseite, die auf dem Handy perfekt aussieht und super schnell lädt. Unsere Tisch-Reservierungen sind massiv hochgegangen.",
        "testi.q2.name": "Sarah Weber",
        "testi.q2.role": "Geschäftsführerin, Restaurant",
...
// ---------- AR ----------
      ar: {
        ...
        "demos.d5.title": "استوديو يوغا",
        "demos.d5.text": "تصميم هادئ وبسيط يركز على المدرب مع دعوة واضحة لحجز حصة تجريبية.",
        "demos.d5.result": "المزيد من الاستفسارات عن الحصص بفضل تجربة المستخدم المريحة.",
        "demos.d6.title": "معرض سيارات",
        "demos.d6.text": "تصميم يبني الثقة مع تركيز على الخبرة، تقييمات العملاء، وسهولة الاستفسار عن السيارات.",
        "demos.d6.result": "المزيد من الاستفسارات وزيادة ثقة المشترين.",
        "demos.d7.title": "وسيط عقاري",
        "demos.d7.text": "عرض حصري للعقارات عالية الجودة بمرشحات ذكية وتصميم أنيق للوضع الداكن.",
        "demos.d7.result": "ثقة أعلى والمزيد من العملاء المحتملين المؤهلين.",
        "demos.d8.title": "متجر إلكتروني",
        "demos.d8.text": "تجربة تجارة إلكترونية مميزة. بطاقات منتجات جمالية، وطرق دفع سلسة، وأوقات تحميل سريعة جدًا.",
        "demos.d8.result": "معدل تحويل أعلى بين زوار المتجر.",
        "demos.tag.starter": "باقة المبتدئين",
        "demos.tag.business": "باقة الأعمال",
        "demos.tag.premium": "باقة البريميوم",
        ...
        "marquee.title": "موثوق من قبل رواد السوق المحليين",
        "testi.kicker": "آراء العملاء",
        "testi.title": "ماذا يقول عملاؤنا.",
        "testi.subtitle": "مواقع تقدم نتائج حقيقية في الواقع.",
        "testi.q1.text": "منذ أن حصلنا على الموقع الجديد من Lumi Digital، تضاعف عدد استفساراتنا الجديدة ثلاث مرات. كانت العملية احترافية وسريعة للغاية!",
        "testi.q1.name": "يوهانس مولر",
        "testi.q1.role": "مالك، شركة حرفية",
        "testi.q2.text": "أخيرًا موقع يبدو مثاليًا على الهاتف المحمول ويحمل بسرعة فائقة. لقد زادت حجوزات الطاولات لدينا بشكل كبير.",
        "testi.q2.name": "سارة ويبر",
        "testi.q2.role": "مديرة، مطعم",
